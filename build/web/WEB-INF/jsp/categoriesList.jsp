                            ...
                            <ul class="list-group">
                                <c:forEach var="category" items="${categories}">
                                    <li class="list-group-item"><span class="glyphicon glyphicon-pencil text-primary"></span>
                                        <c:out value="${category.titre}" /><a href="${pageContext.request.contextPath}/supprimer-category-list?categoryID=<c:out value="${category.id}" />">[delete]</a><a href="${pageContext.request.contextPath}/modifier-category?categoryID=<c:out value="${category.id}" />">[modify]</a>
                                    </li>
                                </c:forEach>
