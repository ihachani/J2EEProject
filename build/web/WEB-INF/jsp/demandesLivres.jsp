                ...
                <div class="panel-group" id="accordion">
                    <div class="panel panel-default">
                        ...
                        <div id="collapseOne" class="panel-collapse collapse in">
                            <ul class="list-group">
                                <c:forEach var="demande" items="${demandesLivres}">
                                    <li class="list-group-item"><span class="glyphicon glyphicon-pencil text-primary"></span>
                                        <c:out value="${demande.titre}" /><a href="${pageContext.request.contextPath}/demande-livre-reponse?demandeID=<c:out value="${demande.id}" />">[respond]</a>
                                    </li>
                                </c:forEach>
