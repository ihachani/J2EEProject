    ...
    <div class="container">
        <form:form  action="#" method="post">
            <div class="form-group">
                ...
                <form:input path="isbn" type="text" placeholder="Name" required="" id="titre" class="form-control" />
            </div>
            ...
            <div class="form-group">
                <label class="sr-only" for="isbn">auteurs</label>
                <label for="isbn">auteurs</label>
                <form:input path="auteurs" type="text" placeholder="Name" required="" id="titre" class="form-control" />
            </div>
            ...
            <div class="form-group">
                <label class="sr-only" for="isbn">dayPublication</label>
                <label for="isbn">dayPublication</label>
                <form:input path="dayPublication" type="text" placeholder="Name" required="" id="titre" class="form-control" />
                <label class="sr-only" for="isbn">monthPublication</label>
                <label for="isbn">monthPublication</label>
                <form:input path="monthPublication" type="text" placeholder="Name" required="" id="titre" class="form-control" />
                <label class="sr-only" for="isbn">yearPublication</label>
                <label for="isbn">yearPublication</label>
                <form:input path="yearPublication" type="text" placeholder="Name" required="" id="titre" class="form-control" />
            </div>
            
                <!--div class="form-group">
                <label class="sr-only" for="isbn">file</label>
                <label for="isbn">file</label>
                < form:input path="file" type="file" enctype="multipart/form-data" />
            </div>-->
